tag @a[nbt={RootVehicle: {Entity: {Rotation: [0.0f,0.0f], Motion: [0.0d,0.0d,2.074d], id:"minecraft:minecart"}},equipment: {offhand: {id: "minecraft:lapis_block"}}, SelectedItem: {id: "minecraft:gold_block"}}] add x
